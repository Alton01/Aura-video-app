  ...
  return (
    <SafeAreaView className='bg-primary h-full'>
        <ScrollView className='px-4 my-6'>
          ...
          <FormField title="Video Title" value={form.title}
          ...
          <View className="mt-7 space-y-2">
            ...
            <TouchableOpacity onPress={() => openPicker('video')} >
                {form.video ? (
                  ...
                  className='w-full h-64 rounded-2xl'  resizeMode={ResizeMode.COVER}
                   />
                ) : (
          ...
          placeholder="The prompt used in creating this video"
